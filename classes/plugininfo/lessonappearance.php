...
namespace mod_lesson\plugininfo;

use core\plugininfo\base;
use core_plugin_manager;

/**
 * Lesson appearance subplugin info class.
 *
 * @package   mod_lesson
 * @copyright 2026 David Herney @ BambuCo
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class lessonappearance extends base {
    ...
    public static function get_enabled_plugins() {
        ...
        $plugins = core_plugin_manager::instance()->get_installed_plugins('lessonappearance');
        if (!$plugins) {
            return array();
        }
        $installed = array();
        foreach ($plugins as $plugin => $version) {
            $installed[] = 'lessonappearance_'.$plugin;
        }
    ...
    public static function enable_plugin(string $pluginname, int $enabled): bool {
        ...
        $plugin = 'lessonappearance_' . $pluginname;
