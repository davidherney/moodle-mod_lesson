...
$string['createnewdesign'] = 'Create new design';
$string['configuredesign'] = 'Configure design: {$a}';
...
$string['designdeleted'] = 'Appearance design deleted';
...
$string['lesson:manageappearancedesigns'] = 'Manage appearance designs';
$string['lesson:manageoverrides'] = 'Manage lesson overrides';
$string['manageappearancedesigns'] = 'Manage appearance designs';
...
$string['uniqueid_help'] = 'A unique cross-site identifier for this design, e.g. mydesign@site.com. It can be used to reference this design from other sites.';
$string['uniqueidalreadyexists'] = 'A design with this unique identifier already exists';
...
$string['subplugintype_lessonappearance_plural'] = 'Lesson appearance designs';
